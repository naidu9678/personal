...
public class TestwsSOAPSkeleton implements org.example.www.testws.Testws_PortType, org.apache.axis.wsdl.Skeleton {
    private org.example.www.testws.Testws_PortType impl;
    ...
    */
    ...
    static {
        ...
        _oper.setElementQName(new javax.xml.namespace.QName("http://www.example.org/testws/", "NewOperation"));
        _oper.setSoapAction("http://www.example.org/testws/NewOperation");
    ...
    public TestwsSOAPSkeleton() {
        this.impl = new org.example.www.testws.TestwsSOAPImpl();
    }

    public TestwsSOAPSkeleton(org.example.www.testws.Testws_PortType impl) {
        this.impl = impl;
    }
